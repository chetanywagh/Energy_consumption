...
- \ud83d\uddd5\ufe0f Forecast start date is fixed at **2018-01-02**
- \ud83d\udcca Data is resampled from hourly to daily granularity
""")
...
start_date = datetime(2018, 1, 2).date()
st.sidebar.markdown("**Forecast Start Date:**")
st.sidebar.markdown(f"\ud83d\uddd5\ufe0f `{start_date}` (fixed)")
...
for spine in ax.spines.values():
    spine.set_edgecolor("#0A5275")
    spine.set_linewidth(2)

ax.set_facecolor("#f7fbfc")
fig.patch.set_facecolor("#e9f1f7")
ax.grid(True, linestyle='--', linewidth=0.5, color='gray', alpha=0.7)

ax.set_title("Daily Energy Consumption Forecast", fontsize=14, fontweight='bold', color="#0A5275")
ax.set_xlabel("Date")
ax.set_ylabel("MW")
fig.autofmt_xdate()
